...
const Header = ({displayCategory,filteredProducts}) => {
  return (
    <header className="px-8 md:px-16 mb-16 max-w-480 mx-auto pt-32 pb-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <p className="mt-6 text-on-surface-variant max-w-xl text-lg leading-relaxed">
              Curated items tailored for the modern minimalist, exploring architectural form and timeless aesthetics.
            </p>
          </div>
